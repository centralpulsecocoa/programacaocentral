-- =====================================================================
-- CENTRAL PULSE — Script de Criação do Banco PostgreSQL
-- =====================================================================
-- Banco: central_pulse
-- Data: 2026-06-22
-- =====================================================================

-- Criar o banco de dados (executar como superuser, fora de um bloco transacional)
-- CREATE DATABASE central_pulse
--   WITH ENCODING 'UTF8'
...
CREATE SCHEMA IF NOT EXISTS sustentabilidade;
...
-- =====================================================================
-- 10. SUSTENTABILIDADE — FAZENDA_ATRIBUICOES
-- =====================================================================
...
-- =====================================================================
-- 11. SUSTENTABILIDADE — FAZENDA_CHECKLISTS
-- =====================================================================
...
-- =====================================================================
-- 12. SUSTENTABILIDADE — TECNICOS_SUSTENTABILIDADE
-- =====================================================================
...
-- =====================================================================
-- 13. SUSTENTABILIDADE — SUSTENTABILIDADE_CONFIGS
-- =====================================================================
...
-- =====================================================================
-- 23. SISTEMA — MB52_STOCK (Estoque SAP)
-- =====================================================================
...
-- =====================================================================
-- 25. SISTEMA — TRANSACTION_LOGS (Auditoria)
-- =====================================================================
...
-- =====================================================================
-- FOREIGN KEYS (Referenciais)
-- =====================================================================

-- Fazenda atribuições referenciam produtores
-- ALTER TABLE sustentabilidade.fazenda_atribuicoes
--   ADD CONSTRAINT fk_fa_produtor
--   FOREIGN KEY (produtor_id) REFERENCES sustentabilidade.produtores(produtor_id);

-- Fazenda checklists referenciam produtores
-- ALTER TABLE sustentabilidade.fazenda_checklists
--   ADD CONSTRAINT fk_fc_produtor
--   FOREIGN KEY (produtor_id) REFERENCES sustentabilidade.produtores(produtor_id);

-- Meeiros referenciam produtores
-- ALTER TABLE sustentabilidade.meeiros
--   ADD CONSTRAINT fk_me_fazenda
--   FOREIGN KEY (id_fazenda) REFERENCES sustentabilidade.produtores(produtor_id);
